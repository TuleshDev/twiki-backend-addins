...
const updateCommonDiskHelper = (commonDisk, pageHelper) => {
  /*
  assetFolders: null,
  ...
  */
  ...
  commonDisk.processPage = async ({ user, fullPath, relPath, contentType, moduleName }) => {
...
module.exports = updateCommonDiskHelper
